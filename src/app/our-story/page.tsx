      ...
      <section className="py-20 bg-gradient-to-br from-platinum-50 to-platinum-100 dark:from-gray-800 dark:to-gray-700">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* During Treatment */}
            <div className="group bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg cursor-default">
              <div className="relative mb-6">
                <div className="relative w-64 h-64 mx-auto">
                  <div className="absolute inset-0 bg-gradient-to-br from-violet-400 to-fandango-400 rounded-full opacity-20 transition-opacity"></div>
                  <Image
            ...
            <div className="group bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg cursor-default">
              <div className="relative mb-6">
                <div className="relative w-64 h-64 mx-auto">
                  <div className="absolute inset-0 bg-gradient-to-br from-saffron-400 to-orange-400 rounded-full opacity-20 transition-opacity"></div>
                  <Image
            ...
            <div className="group bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg cursor-default">
              <div className="relative mb-6">
                <div className="relative w-64 h-64 mx-auto">
                  <div className="absolute inset-0 bg-gradient-to-br from-fandango-400 to-violet-400 rounded-full opacity-20 transition-opacity"></div>
                  <Image
