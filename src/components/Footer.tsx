          ...
          <div>
            ...
            <div className="pt-6">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-5 py-2 bg-(--color-kccf-purple) text-white font-medium rounded-xl shadow hover:bg-(--color-violet-600) transition"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2.94 6.34L10 11l7.06-4.66A2 2 0 0016 4H4a2 2 0 00-1.06 2.34z" />
                  <path d="M18 8.12l-8 5.28-8-5.28V14a2 2 0 002 2h12a2 2 0 002-2V8.12z" />
                </svg>
                Subscribe
              </Link>
            </div>
